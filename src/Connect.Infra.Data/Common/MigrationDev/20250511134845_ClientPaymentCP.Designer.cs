...
namespace Connect.Common.MigrationDev
{
    ...
    [Migration("20250511134845_ClientPaymentCP")]
    partial class ClientPaymentCP
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Connect.ClientPaymentDao", b =>
                {
                    ...
                    b.Property<Guid?>("ChannelPartnerId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Connect.ClientPaymentDao", b =>
                {
                    b.HasOne("Connect.ChannelPartnerDao", "ChannelPartner")
                        .WithMany()
                        .HasForeignKey("ChannelPartnerId1");
