...
namespace Connect.Common.MigrationDev
{
    ...
    [Migration("20250510060927_UpdatedByNotRequired")]
    partial class UpdatedByNotRequired
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Connect.NewInventoryDao", b =>
                {
                    ...
                    b.Property<float?>("RevisedRate")
                        .HasColumnType("real")
                        .HasColumnName("revised_rate");

                    b.Property<float?>("RevisedTotalConsideration")
                        .HasColumnType("real")
            ...
            modelBuilder.Entity("Connect.SoldInventoryDao", b =>
                {
                    ...
                    b.Property<float?>("RevisedAssuredPrice")
                        .HasColumnType("real")
